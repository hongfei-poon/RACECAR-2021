...
# Unet_BCELoss_Adam
ModelFolder = '/home/scut/qingzhou_ws2/src/csi_cam_test/scripts/traffic_light/line/Output'
#ModelFolder = './Output'
...
Unet.load_state_dict(torch.load(os.path.join(ModelFolder, 'checkpoint3.pt'), map_location=Device))  # 700
Unet.eval()
# 测试模式
