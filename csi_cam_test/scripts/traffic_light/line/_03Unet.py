...
if __name__ == '__main__':
	...
	#Unet = UNet(in_channels=1, out_channels=2,init_features=32, WithActivateLast = True, ActivateFunLast = torch.sigmoid)      # 2分类输出为两个通道
	#Unet = UNet(in_channels=1, out_channels=2)
	#原来代码无法执行-未设置ActivateFunLast
	Unet = UNet(in_channels=1, out_channels=2,init_features = 32, WithActivateLast = True, ActivateFunLast = torch.sigmoid)
